...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const gridGameHub = document.getElementById("grid-GameHub");       // Asegúrate de tener este ID en tu HTML
    ...
    GameHub.addEventListener("click", (event) => {
        ...
        // Si tu Pokédex usa CSS Grid para las tarjetas de Pokémon, cámbialo aquí a "grid"
        gridPokedex.style.display = "none";       // Muestra Pokédex
        gridGameHub.style.display = "grid";       // Muestra Pokédex
    });
